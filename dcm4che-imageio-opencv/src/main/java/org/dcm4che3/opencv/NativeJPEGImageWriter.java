 ...
 * @since Aug 2018
 */
class NativeJPEGImageWriter extends AbstractNativeImageWriter {
    ...
    MatOfInt buildDicomParams(ImageCV mat, RenderedImage image, ImageWriteParam param, ImageDescriptor desc) {
        ...
        params[Imgcodecs.DICOM_PARAM_COLOR_MODEL] = getCodecColorSpace(desc.getPhotometricInterpretation()); // Photometric interpretation
